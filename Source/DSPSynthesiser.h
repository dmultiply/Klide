...
//==============================================================================
/**
 Describes one of the sounds that a DSPSynthesiser can play.
 
 A DSPSynthesiser can contain one or more sounds, and a sound can choose which
 midi notes and channels can trigger it.
 
 The DSPSynthesiserSound is a passive class that just describes what the sound is -
 the actual audio rendering for a sound is done by a DSPSynthesiserVoice. This allows
 more than one DSPSynthesiserVoice to play the same sound at the same time.
 
 @see DSPSynthesiser, DSPSynthesiserVoice
...
class DSPSynthesiserSound    : public ReferenceCountedObject
    {
    protected:
        //==============================================================================
        DSPSynthesiserSound();
    ...
    public:
        /** Destructor. */
        ~DSPSynthesiserSound() override;
        
        //==============================================================================
        /** Returns true if this sound should be played when a given midi note is pressed.
         
         The DSPSynthesiser will use this information when deciding which sounds to trigger
         for a given note.
         */
        ...
        using Ptr = ReferenceCountedObjectPtr<DSPSynthesiserSound>;
        
        
    private:
        //==============================================================================
        JUCE_LEAK_DETECTOR (DSPSynthesiserSound)
    };
    
    
    //==============================================================================
    /**
     Represents a voice that a DSPSynthesiser can use to play a DSPSynthesiserSound.
     
     A voice plays a single sound at a time, and a DSPSynthesiser holds an array of
     voices so that it can play polyphonically.
     
     @see DSPSynthesiser, DSPSynthesiserSound
     
     @tags{Audio}
     */
    class DSPSynthesiserVoice
    {
    public:
        //==============================================================================
        /** Creates a voice. */
         ...
         */
        DSPSynthesiserSound::Ptr getCurrentlyPlayingSound() const noexcept     { return currentlyPlayingSound; }
         ...
         */
        virtual bool canPlaySound (DSPSynthesiserSound*) = 0;
        ...
        /** Renders the next block of data for this voice.
         ...
         block, it must call clearCurrentNote(), to tell the DSPSynthesiser that it has finished.
        ...
        bool wasStartedBefore (const DSPSynthesiserVoice& other) const noexcept;
    ...
    /**
     ...
     To create a DSPSynthesiser, you'll need to create a subclass of DSPSynthesiserSound
     to describe each sound available to your synth, and a subclass of DSPSynthesiserVoice
     which can play back one of these sounds.
     
     Then you can use the addVoice() and addSound() methods to give the DSPSynthesiser a
     ...
     @tags{Audio}
     */
    class DSPSynthesiser
    {
    public:
        //==============================================================================
        /** Creates a new DSPSynthesiser.
         You'll need to add some sounds and voices before it'll make any sound.
         */
        DSPSynthesiser();
        
        /** Destructor. */
        virtual ~DSPSynthesiser();
        ...
        DSPSynthesiserVoice* getVoice (int index) const;
        
        /** Adds a new voice to the synth.
         
         All the voices should be the same class of object and are treated equally.
         
         The object passed in will be managed by the DSPSynthesiser, which will delete
         it later on when no longer needed. The caller should not retain a pointer to the
         voice.
         */
        DSPSynthesiserVoice* addVoice (DSPSynthesiserVoice* newVoice);
        ...
        DSPSynthesiserSound::Ptr getSound (int index) const noexcept       { return sounds[index]; }
        
        /** Adds a new sound to the DSPSynthesiser.
         
         The object passed in is reference counted, so will be deleted when the
         DSPSynthesiser and all voices are no longer using it.
         */
        DSPSynthesiserSound* addSound (const DSPSynthesiserSound::Ptr& newSound);
        ...
        //==============================================================================
        /** Tells the DSPSynthesiser what the sample rate is for the audio it's being used to render.
    ...
    protected:
        ...
        OwnedArray<DSPSynthesiserVoice> voices;
        ReferenceCountedArray<DSPSynthesiserSound> sounds;
         ...
         */
        virtual DSPSynthesiserVoice* findFreeVoice (DSPSynthesiserSound* soundToPlay,
                                                 int midiChannel,
                                                 int midiNoteNumber,
         ...
         */
        virtual DSPSynthesiserVoice* findVoiceToSteal (DSPSynthesiserSound* soundToPlay,
                                                    int midiChannel,
         ...
         */
        void startVoice (DSPSynthesiserVoice* voice,
                         DSPSynthesiserSound* sound,
                         int midiChannel,
                         int midiNoteNumber,
                         float velocity);
        ...
        /** Stops a given voice.
         ...
         DSPSynthesiserVoice::stopNote(), and has some assertions to sanity-check a few things.
         */
        void stopVoice (DSPSynthesiserVoice*, float velocity, bool allowTailOff);
    ...
    private:
        ...
        JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DSPSynthesiser)
    };
